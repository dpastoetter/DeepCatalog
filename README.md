...
```bash
gh attestation verify deepcatalog-0.6.3.tar.gz \
...
- push a version tag (`git tag v0.6.3 && git push origin v0.6.3`) — intended path
...
./scripts/build-appimage.sh v0.6.3
# dist/DeepCatalog-0.6.3-x86_64.AppImage
```
