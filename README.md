...
```bash
gh attestation verify deepcatalog-0.6.2.tar.gz \
...
- push a version tag (`git tag v0.6.2 && git push origin v0.6.2`) — intended path
...
./scripts/build-appimage.sh v0.6.2
# dist/DeepCatalog-0.6.2-x86_64.AppImage
```
