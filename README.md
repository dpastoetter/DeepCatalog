...
```bash
gh attestation verify deepcatalog-0.6.4.tar.gz \
...
- push a version tag (`git tag v0.6.4 && git push origin v0.6.4`) — intended path
...
./scripts/build-appimage.sh v0.6.4
# dist/DeepCatalog-0.6.4-x86_64.AppImage
```
